    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        catch (Exception e)
        {
           ...
           ObservableList<PieChart.Data> pieChartData =
                ...
                new PieChart.Data("Dublin",result1),
                new PieChart.Data("Cork", result2),
                new PieChart.Data("Donegal", result3),
                new PieChart.Data("Laois", result4),
                new PieChart.Data("Mayo", result5),
                new PieChart.Data("Longford", result6));
